...
declare -A nodes_map=(["controller01"]="192.168.2.101" ["controller02"]="192.168.2.102" ["controller03"]="192.168.2.103" ["compute01"]="192.168.2.104" ["compute02"]="192.168.2.105" ["compute03"]="192.168.2.106" ["compute04"]="192.168.2.107" );
declare -A controller_map=(["controller01"]="192.168.2.101" ["controller02"]="192.168.2.102" ["controller03"]="192.168.2.103");
declare -A hypervisor_map=(["compute01"]="192.168.2.104" ["compute02"]="192.168.2.105" ["compute03"]="192.168.2.106" ["compute04"]="192.168.2.107" );
...
ftp_info="ftp://192.168.100.81/pub/share/"
### 临时目录，用于scp存放配置脚本
